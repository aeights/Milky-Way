...
<body class="">
    ...
    <div class="z-[2] fixed bg-[#E4E5EA] h-[100vh] w-[250px] flex flex-col items-center">
        ...
        <ul class="">
            ...
            <li class="my-5">
                <a class="hover:bg-[#B2A4FF] duration-200 py-4 text-start pl-14 w-[210px] block rounded-lg drop-shadow-lg" href="/dashboardPenjual/penarikan">Penarikan</a>
            </li>
            <li class="my-5">
                <a class="hover:bg-[#B2A4FF] duration-200 py-4 text-start pl-14 w-[210px] block rounded-lg drop-shadow-lg" href="/dashboardPenjual/riwayat">Riwayat</a>
            </li>
        </ul>
    </div>
