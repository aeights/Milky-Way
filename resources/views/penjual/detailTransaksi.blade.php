        ...
        <form class="flex flex-row mx-auto" action="{{url('/konfirmasiTransaksi/'.$transaksi->id)}}" method="post" onsubmit="return confirm('Konfirmasi Pesanan Ini?')" enctype="multipart/form-data">
            ...
            <div class="flex p-4 border shadow-md rounded-md">
                <div class="">
                    ...
                    <div>
                        <button class="bg-[#B2A4FF] mr-2 p-2 rounded-md hover:bg-slate-500 duration-200 drop-shadow-lg">Konfirmasi</button>
                        <a class="bg-[#B2A4FF] p-2 rounded-md hover:bg-slate-500 duration-200 drop-shadow-lg" href="/dashboardPenjual/pengiriman">Kembali</a>
                    </div>
                </div>
                <div class="">
