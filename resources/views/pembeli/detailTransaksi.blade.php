...
@section('content')
    <div class="pt-28 flex">
        <form class="flex flex-row mx-auto" action="{{url('/konfirmasiTransaksi/'.$transaksi->id)}}" method="post" onsubmit="return confirm('Note: Pastikan nominal transfer sudah benar')" enctype="multipart/form-data">
            @csrf
            ...
            <div class="">
                ...
                <div class="mr-16 border rounded-md p-4 shadow">
                    ...
                    <div class="mb-2">
                        <p class="text-sm mb-1">Total Transfer</p>
                    ...
                    <div class="mb-2">
                        <p class="text-sm mb-1">Bukti Transfer</p>
